...
publist = {
    ...
    "incollection": {
        ...
        "venue-pretext": "In: ",
        "collection": {"name": "publications", "permalink": "/publication/"},
        "type": "incollection",  # Book chapters
    },
    "report": {
        "file": "pubs.bib",
    ...
    "inproceedings": {
        ...
        "collection": {"name": "publications", "permalink": "/publication/"},
        "type": "inproceedings",  # Conference proceedings
    },
}
...
def should_include_entry(entry, entry_type):
    """Filter entries based on type and year"""
    if entry_type == "inproceedings":
        # Apply 5-year filter for conference proceedings
        if "year" in entry.fields:
            pub_year = int(entry.fields["year"])
...
for pubsource in publist:
    ...
    for bib_id in bibdata.entries:
        ...
        # Add filtering check
        if not should_include_entry(entry, publist[pubsource].get("type", "")):
            continue
        ...
        try:
            ...
            # Add category based on entry type
            md += "\ncategory: " + entry.type
